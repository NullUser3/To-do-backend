...
import com.example.collaborative.to_do_list.dto.user.UserResponse.UserResponsePublic;
...
public class UserController {
	...
	public ResponseEntity<UserResponsePublic> getMethodName(@PathVariable UUID id) throws Exception {
		User user = userService.findById(id);
		UserResponsePublic userResponse = UserResponsePublic.in(user);
